    ...
    <>
      ...
      <div className="relative bg-gradient-to-br from-terminal-dark via-black to-neutral-950 min-h-screen text-terminal-light-gray font-mono p-6 sm:p-10 lg:p-16 overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto space-y-20 lg:space-y-24">
          ...
          {/* --- Section Statut Actuel (Optionnelle) --- */}
          {currentStatus.seeking && (
            <section className="p-6 md:p-8 border border-green-700 rounded-lg bg-green-900/20 shadow-lg shadow-black/30">
              ...
              <Link 
                href={currentStatus.contactLink || '/#contact'} // Lien vers contact ou section contact sur la home
              ...
              >
                Me Contacter
                <svg className="w-4 h-4 transition-transform group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
              </Link>
            </section>
          )}
                    ...
                    <div>
                       ...
                       <div className="flex flex-wrap gap-2">
                        {job.techStack.map(tech => (
                          <span key={tech} className="px-3 py-1 bg-neutral-800 border border-neutral-700 text-neutral-400 text-xs rounded">
                            {tech}
                          </span>
                        ))}
                      </div>
